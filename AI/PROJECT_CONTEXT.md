# PROJECT CONTEXT — GESTALT v0.031
...
## Release identity
Package/server/cache/root VERSION and `js/app.js` now all report `0.031`. This keeps dictionary query cache-busting and exported progress filenames aligned with the release identity.
