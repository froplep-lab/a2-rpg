...
const SHELL=['./','./index.html','./css/main.css','./js/app.js','./data/book-vocabulary-manifest.json','./data/words.compact.json','./data/words.json','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png'];
