...
assert.ok(words.every(w=>w.german&&w.ukrainian&&w.emoji&&w.sentence&&w.sentenceUa&&w.phonetic&&w.topicId&&w.sourcePage),'word record missing required study/source fields');
